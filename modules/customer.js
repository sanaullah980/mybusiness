...
// --- MAIN CUSTOMER PROFILE & REPORT MODAL ---
export function openCustomerProfileModal(customerId) {
    ...
    // Build horizontal scrolling table for report
...
// --- EXPOSE TO WINDOW (So HTML onclick works without changing app.js) ---
