export function renderSettings(container) {
    ...
    container.innerHTML = `
        <div class="card">
            <h3>Mobile App</h3>
            <p style="margin-bottom:15px; font-size:14px; color:var(--gray);">Get the native Android app.</p>
        ...
        ` : `
            <div class="card">
                ...
                <p style="font-size:12px; color:var(--gray);">Password managed by Google.</p>
            </div>
        `}
    `;
}
...
export async function saveSettings() {
    ...
    try {
        ...
        window.hideLoading('btn-save-settings');
    }
}
...
export async function changePassword() {
    ...
    try {
        ...
        window.hideLoading('btn-cp-submit');
    }
}